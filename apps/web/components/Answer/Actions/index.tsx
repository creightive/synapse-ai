...
const Actions = ({}: ActionsProps) => {
  ...
  return (
    <>
      <div className="flex">
        <button
          className={`btn-stroke btn-square btn-medium mr-3 ${like ? '!border-primary-3 !bg-primary-3 !fill-n-1' : ''}`}
        ...
        <button
          className={`btn-stroke btn-square btn-medium mr-3 ${
            dislike ? '!border-primary-3 !bg-primary-3 !fill-n-1' : ''
          }`}
            ...
            toast(t => (
              <Notify className="block w-[23.5rem] p-6 rounded-3xl md:w-[21.5rem]">
                <div className="flex items-center mb-6 text-base-1 font-semibold">
                  <Icon className="w-6 h-6 mr-2 fill-n-1" name="check" />
                  Message selected
                </div>
                <div className="flex">
