          ...
          >
            <form className="" action="" onSubmit={() => console.log('Submit')}>
              <div className="mb-10 text-center">
                <div className="mb-2 text-h4">Invite team members</div>
              ...
              <Field
                ...
                required
              />
              <button className="btn-stroke w-full mb-10" type="button">
                <span>Add additional email addresses</span>
                <Icon name="plus" />
              </button>
              <button className="btn-gradient btn-medium w-full" type="submit">
