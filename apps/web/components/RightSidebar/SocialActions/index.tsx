  ...
  return (
    <>
      <div className="space-y-1">
        <Action title="Make longer" icon="add-circle-stroke" onClick={() => console.log('Make longer')} />
        <Action title="Add more hashtag" icon="add-circle-stroke" onClick={() => console.log('Add more hashtag')} />
        <Action title="Improve writing" icon="cube" onClick={() => console.log('Improve writing')} />
        <Action
      ...
      <div className="mt-4 pt-4 border-t border-n-3 dark:border-n-5">
        ...
        <button
          ...
          onClick={() =>
            toast(t => (
              <Notify className="md:flex-wrap md:rounded-2xl" iconCheck>
                ...
                <button className="btn-light btn-medium md:w-full md:mt-4" onClick={() => toast.dismiss(t.id)}>
                  <span>View</span>
                  <Icon name="share" />
                </button>
              </Notify>
