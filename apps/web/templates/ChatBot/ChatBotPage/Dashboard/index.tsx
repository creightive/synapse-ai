  ...
  return (
    <>
      <div className="flex items-center mb-12 2xl:block md:-mx-5 md:mb-5 md:px-5 md:pb-5 md:border-b md:border-n-3 dark:md:border-n-5">
        <div className="mr-auto text-h3 2xl:mr-0 2xl:mb-4 md:text-h5">Dashboard</div>
        <div className="flex items-center">
          <Select className="min-w-[11rem] mr-3" items={durations} value={duration} onChange={setDuration} />
          <button className="btn-stroke shrink-0">Download CSV</button>
        </div>
      </div>
