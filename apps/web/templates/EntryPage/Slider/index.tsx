        ...
        <SplideSlide className="flex grow" key={index}>
          <div className="flex w-full min-h-screen min-h-screen-ios py-8">
            <div className="relative flex justify-center items-center grow p-8">
              <Image className="object-cover rounded-5xl" src={item.image} fill alt="" />
              <div className="relative z-1 max-w-[30.25rem] w-full text-center text-h4 text-n-1">{item.content}</div>
            </div>
          </div>
        </SplideSlide>
      ))}
