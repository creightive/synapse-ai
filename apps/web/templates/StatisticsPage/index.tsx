    ...
    <Layout>
      <Chat background="/images/bg-4.jpg">
        <Question
          content={
            <>
              Hey, I'll give you a link to my Dribbble portfolio. Your mission is to provide me with the stats of this
              page:&nbsp;
              <a
        ...
        <Answer content="These are the statistics for that Dribbble portfolio." message="Generating answers for you…">
