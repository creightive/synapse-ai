  ...
  return (
    <form className="" action="" onSubmit={() => console.log('Submit')}>
      ...
      <div className="mb-12 text-base-1 text-n-4 lg:mb-8">
        Warning: Deleting your account will permanently remove all of your data and cannot be undone. This includes your
        profile, conversations, comments, and any other information associated with your account. Are you sure you want
