  ...
  return (
    <form className="" action="" onSubmit={() => console.log('Submit')}>
      ...
      <div className="mb-12 lg:mb-8">
        {checkboxes.map(checkbox => (
          ...
          >
            ...
            >
              <Image className="w-5" src={checkbox.image} width={20} height={20} alt="" />
            </div>
            <div className="grow">
              <div className="mb-1 text-base-2 font-semibold">{checkbox.title}</div>
              <div
      ...
      <div className="inline-flex px-6 bg-gradient-to-b from-[#9A77FF] to-[#735FFA] rounded-full">
        <button className="mr-3 text-base-1 font-bold text-n-1">Export</button>
