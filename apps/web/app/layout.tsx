...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <head>
        <meta name="description" content="Figma UI kit designed to enhance the functionality of ChatGPT" />
        <meta name="product-name" content="Synapse - AI UI Kit" />
        {/* Twitter Card data */}
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:site" content="@ui8" />
        <meta name="twitter:title" content="Synapse - AI UI Kit" />
        <meta name="twitter:description" content="Figma UI kit designed to enhance the functionality of ChatGPT" />
        ...
        <meta property="og:description" content="Figma UI kit designed to enhance the functionality of ChatGPT" />
        <meta property="og:site_name" content="Synapse - AI UI Kit" />
        <meta property="fb:admins" content="132951670226590" />
        {/* Open Graph data for LinkedIn */}
        <meta property="og:title" content="Synapse - AI UI Kit" />
        <meta property="og:url" content="https://ui8.net/ui8/products/synapse-ai-ui-kit" />
        <meta property="og:image" content="%PUBLIC_URL%/linkedin-og-image.png" />
        <meta property="og:description" content="Figma UI kit designed to enhance the functionality of ChatGPT" />
        {/* Open Graph data for Pinterest */}
        <meta property="og:title" content="Synapse - AI UI Kit" />
        <meta property="og:url" content="https://ui8.net/ui8/products/synapse-ai-ui-kit" />
        <meta property="og:image" content="%PUBLIC_URL%/pinterest-og-image.png" />
        <meta property="og:description" content="Figma UI kit designed to enhance the functionality of ChatGPT" />
      </head>
      <body
