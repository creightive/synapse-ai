  ...
  return (
    <div className={`mt-12 text-center ${hidden ? 'hidden' : ''}`}>
      <div className="relative py-8 px-4 pb-4 bg-primary-6 rounded-3xl">
        ...
        >
          <Icon className="fill-n-5 transition-colors group-hover:fill-color-5 dark:fill-n-3" name="close" />
        </button>
        <div className="max-w-[10rem] mx-auto mb-8">
          <Image className="w-full" src="/images/empty-chat.png" width={160} height={160} alt="" />
        </div>
        <Link className="btn-blue-dark w-full text-base-1 font-bold" href="/pricing-and-payment">
