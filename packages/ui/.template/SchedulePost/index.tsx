...
const SchedulePost = ({}: SchedulePostProps) => {
  ...
  return (
    <>
      <button className="btn-stroke w-full mt-3" onClick={() => setVisibleModal(true)}>
      ...
      >
        ...
        <div className="p-6 bg-n-2 rounded-xl text-n-4 md:p-4 dark:bg-n-7">
          ...
          create a stunning hero header concept. Check it out and see how AI tech can be used to help you level up your
          designs! 📈 <span className="text-primary-3 dark:text-primary-4">#design #ai #cinema4d #redshift</span>
        </div>
          ...
          <div className="flex-1 md:mb-4">
            ...
            <div className="relative">
              <DatePicker
                ...
                formatWeekDay={(nameOfDay: any) => nameOfDay.toString().slice(0, 1)}
                dayClassName={dayClassName}
              />
              <Icon className="absolute top-3.5 left-4 fill-n-4 pointer-events-none" name="calendar-check" />
            </div>
          </div>
          <div className="basis-1/2">
            ...
            <div className="relative">
              <DatePicker
                ...
                dateFormat="h:mm aa"
              />
              <Icon className="absolute top-3.5 left-4 fill-n-4 pointer-events-none" name="clock" />
            </div>
          </div>
        </div>
        <button className="btn-gradient btn-medium mt-6 md:w-full" ref={buttonRef}>
          Schedule
        </button>
      </Modal>
    </>
