...
const Video = ({}: VideoProps) => (
  <div className="relative aspect-video">
    <Image className="object-cover rounded-2xl" src="/images/video-pic.jpg" fill alt="" />
    <div className="absolute top-4 right-4 flex md:hidden">
      <div className="mr-2 px-4 py-2 bg-n-1 rounded-lg shadow-3 text-base-2 font-bold dark:bg-n-6">16:9</div>
      <div className="flex justify-center items-center w-10 h-10 rounded-lg bg-n-1 shadow-3 dark:bg-n-6">
        <div className="w-6 h-6 rounded-md" style={{ backgroundColor: '#E6E6EB' }}></div>
      </div>
    </div>
    <Play
